...
urlpatterns = [
    ...
    path("fichas/<int:ficha_id>/treinos/", views.gerenciar_treinos, name="gerenciar_treinos"),
    path("fichas/<int:ficha_id>/ativar/", views.ativar_ficha, name="ativar_ficha"),
    path("treinos/<int:treino_id>/exercicios/", views.editar_treino_exercicios, name="editar_treino_exercicios"),
    path("treinos/<int:treino_id>/remover/", views.remover_treino, name="remover_treino"),
